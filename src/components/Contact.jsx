...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      setLoading(false);
      console.log(error);
      alert('Something went wrong. Please try again or contact me directly at ivanh322@gmail.com.')
    })
  }
      ...
      >
        ...
        >
          ...
          <button
            ...
            shadow-md shadow-primary rounded-xl hover:bg-primary transition-all 
            duration-300"
          >
